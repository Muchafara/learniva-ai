        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-4 md:pt-2">
          ...
          >
            <div className="p-2 bg-black/10 dark:bg-white/10 rounded-lg w-fit">
              <HiQuestionMarkCircle className="w-8 h-8 text-black dark:text-white" />
            </div>
          </motion.div>
          ...
          >
            Find answers to your questions, explore our knowledge base, and get the support you need to make the most of Learniva AI.
          </motion.p>
        </div>
      </section>
    </>
